...
const updateCoupon = async (req, res) => {
    try {
        const { couponId, couponStart, couponExpire, minimumAmount, couponDiscount, couponDescription,couponLimit } = req.body;
...
const addCoupon = async (req, res) => {
    try {
        const {  couponStart, couponExpire, minimumAmount, couponDiscount, couponDescription ,couponLimit} = req.body;
